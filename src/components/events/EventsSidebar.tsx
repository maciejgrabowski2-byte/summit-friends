...
const upcomingEvents = [{
  ...
  distance: "18km",
  elevation: "560m",
  participants: ["https://i.pravatar.cc/32?img=70", "https://i.pravatar.cc/32?img=71", "https://i.pravatar.cc/32?img=72"],
  ...
  distance: "18km",
  elevation: "560m",
  participants: ["https://i.pravatar.cc/32?img=73", "https://i.pravatar.cc/32?img=74", "https://i.pravatar.cc/32?img=75"],
  extraParticipants: 14,
  organizer: "Jean-Chrisian",
  isFull: true
}];
const pastEvents = [{
  ...
  distance: "18km",
  elevation: "560m",
  participants: ["https://i.pravatar.cc/32?img=76", "https://i.pravatar.cc/32?img=77", "https://i.pravatar.cc/32?img=78"],
  extraParticipants: 14,
  organizer: "Jean-Chrisian",
  showReview: true,
  images: ["https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?w=100&h=100&fit=crop", "https://images.unsplash.com/photo-1486870591958-9b9d0d1dda99?w=100&h=100&fit=crop", "https://images.unsplash.com/photo-1519681393784-d120267933ba?w=100&h=100&fit=crop"]
}];
      ...
      <div className="flex gap-3">
        ...
        <div className="min-w-0 flex-1">
          ...
          <div className="flex items-center justify-between">
            ...
            {'isFull' in event && event.isFull && <span className="text-xs text-muted-foreground italic">full</span>}
          </div>
          
          {showReview && 'images' in event && <div className="mt-3 flex items-center gap-2">
              <Button variant="outline" size="sm" className="text-xs h-7">
                Write reviews
              </Button>
            </div>}
          
          {'images' in event && <div className="flex gap-2 mt-3">
              {event.images.map((img, index) => <img key={index} src={img} alt="Event photo" className="w-12 h-12 rounded-lg object-cover" />)}
            </div>}
        </div>
      </div>
    </div>;
...
const EventsSidebar = () => {
  return <div className="space-y-8 border-[#c8d2e4] bg-muted rounded">
      ...
      <div className="px-[20px] py-[20px] bg-muted rounded-[12px]">
